...
class BlogPost(SluggedModel):
    ...
    ai_key_takeaways = models.TextField(blank=True, help_text="One takeaway per line.")
    reading_time = models.PositiveIntegerField(default=3, help_text="Minutes")
    seo_title = models.CharField(max_length=180, blank=True)
    meta_description = models.CharField(max_length=320, blank=True)
    canonical_url = models.URLField(blank=True)
    og_image = models.ImageField(upload_to="blogs/seo/", blank=True, validators=[validate_image_file])
